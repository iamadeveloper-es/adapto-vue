...
import AdaptoChip from '../../../src/lib/components/element/adpt-chip/index.vue'
...
import AdaptoImage from '../../../src/lib/components/element/adpt-image/index.vue'
...
export default {
  ...
  enhanceApp({ app }) {
    ...
    app.component('AdaptoChip', AdaptoChip)
